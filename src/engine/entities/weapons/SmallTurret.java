...
public class SmallTurret extends Weapon {
    public SmallTurret(Vector3f pos, EntityType shotter) {
        super(pos, new Vector2f(1,0), ProjectileType.SMALL_BULLET, new Vector3f(0,18,0), SlotType.SMALL, "Small Turret", shotter);
